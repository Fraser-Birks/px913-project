PROGRAM MAIN
    ...
    part(1)%position = (/0.5_REAL64,-0.5_REAL64/)
    part(1)%velocity = (/-0.01_REAL64,0.01_REAL64/)
    part(2)%position = (/0.0_REAL64,-0.5_REAL64/)
    part(2)%velocity = (/0.0_REAL64,0.01_REAL64/)
    part(3)%position = (/-0.5_REAL64,-0.5_REAL64/)
    part(3)%velocity = (/0.01_REAL64,0.01_REAL64/)
    part(4)%position = (/0.5_REAL64,0.0_REAL64/)
    part(4)%velocity = (/-0.01_REAL64,0.0_REAL64/)
    part(5)%position = (/-0.5_REAL64,0.0_REAL64/)
    part(5)%velocity = (/0.01_REAL64,0.0_REAL64/)
    part(6)%position = (/0.5_REAL64,0.5_REAL64/)
    part(6)%velocity = (/-0.01_REAL64,-0.01_REAL64/)
    part(7)%position = (/0.0_REAL64,0.5_REAL64/)
    part(7)%velocity = (/0.0_REAL64,-0.01_REAL64/)
    part(8)%position = (/-0.5_REAL64,0.5_REAL64/)
    part(8)%velocity = (/0.01_REAL64,-0.01_REAL64/)
    !find dx,dy
